...
use Baum\Node;
use Yaro\Jarboe\Models\Interfaces\NavigationInterface;

/**
 * Navigation
 */
class Navigation extends Node implements NavigationInterface
{
     ...
     * @var string
     */
    protected $table = 'admin_panel_navigation';
