...
<div class="repeater repeater_{{ $repeater->name() }}">
    <div data-repeater-list="{{ $repeater->name() }}">
...
<style>
    ...
    div.repeater div.repeater-item.ui-sortable-helper {
        cursor: grabbing;
    }
</style>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('.repeater_{{ $repeater->name() }}').repeater({
                initEmpty: true,
                show: function () {
                    $(this).slideDown();
            ...
            @if ($repeater->isSortable())
                $('.repeater_{{ $repeater->name() }}').find('.drag').sortable({
                    axis: 'y',
                    handle: '.drag-handle',
                    opacity: 0.5,
