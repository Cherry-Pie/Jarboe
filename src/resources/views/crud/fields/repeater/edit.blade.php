...
@dump($repeater->errors($errors->messages($repeater->name() .'.*')))


<style>
    div.repeater [data="data-repeater-default-item"] {
        display: none;
    }
    div.repeater div.repeater-item {
        position: relative;
        margin-bottom: 6px;
        border: 1px solid #f5f7fa;
    }
    div.repeater div.repeater-item:hover {
        background-color: #94b1ca;
    }
    div.repeater a.repeater-item-delete {
        position: absolute;
        top: 4px;
        right: 4px;
        bottom: auto;
    ...
    .ui-sortable-placeholder.row-dragging {
        background: aliceblue;
    }

    div.repeater .drag-handle {
        height: 30px;
        background-color: #d7dae2;
    }

    div.repeater .drag-handle.sortable {
        cursor: grab;
    }
</style>
                    ...
                    if($self.is('input, textarea, select')) {
                        ...
                        if(typeof newValue === 'undefined') {
                            ...
                            foreach(newValue, function (value, inputName) {
                                console.log(inputName, inputs[inputName])
