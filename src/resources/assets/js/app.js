    ...
    app.SmartActions = function(){
      ...
      var smartActions = {
        ...
        userLogout: function($this){
          ...
          // ask verification
          $.SmartMessageBox({
            title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> "+ $this.data('logout-title') +" <span class='txt-color-orangeDark'><strong>" + $('.login-info').text() + "</strong></span>?",
      ...
      $.root_.on('click', '[data-action="minifyMenu"]', function(e) {
        ...
        if ($('body').hasClass('minified')) {
          Cookies.set('body_class', 'minified');
        }
      ...
      $.root_.on('click', '[data-action="toggleMenu"]', function(e) {
        ...
        if ($('body').hasClass('hidden-menu')) {
          Cookies.set('body_class', 'hidden-menu');
        }
        e.preventDefault();
      });
